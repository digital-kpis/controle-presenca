...
// ⚠️  Sempre que subir arquivos novos no GitHub, incremente o número
//     da versão abaixo (v2 → v3 → v4…) para forçar atualização nos aparelhos.
...
self.addEventListener("fetch", (event) => {
  ...
  // Requisições ao Supabase nunca passam pelo cache
